...
**Project status:** Phase 3 of 5 (QC and group-comparison pipeline). The ML
demonstration and the dashboard are **not implemented yet**. Sections marked
...
| Visualization (matplotlib, CVD-validated palette; plotly planned for the dashboard) | `src/onco_workbench/viz/static.py` |
